    ...
    const fetchData = async () => {
      ...
      try {
        const response2 = await fetch(
          "http://localhost:8788/project-students",
          {
            method: "GET",
          }
        );
    ...
    >
      ...
      {isCSB02Passed ? (
        <>
          ...
          <Paragraph>
            1. นักศึกษาโครงการพิเศษสองภาษาต้องลงทะเบียนเรียนวิชา 040613405
            Special Project II <br />
            2. โดยใช้ ไฟล์ผลการศึกษา จาก Reg Kmutnb
            <br />
            <div style={{ marginLeft: "20px" }}>
              2.1 ผลการศึกษา สามารถ Ctrl + p และเลือก Printer เป็น Save as PDF
              และบันทึกไฟล์ได้ จาก Reg Kmutnb
              <br />
              <a
          ...
          <Upload beforeUpload={handleUploadTranscript} showUploadList={false}>
            <Button className="All-button" type="primary">
